...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v4/lbbackendaddresspool"
...
&lbbackendaddresspool.LbBackendAddressPoolConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v4.lbBackendAddressPool.LbBackendAddressPoolTimeouts,
}
```
