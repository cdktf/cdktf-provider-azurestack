...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v6/lbbackendaddresspool"
...
&lbbackendaddresspool.LbBackendAddressPoolConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v6.lbBackendAddressPool.LbBackendAddressPoolTimeouts,
}
```
