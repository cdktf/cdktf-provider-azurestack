...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v3/lbbackendaddresspool"
...
| <code><a href="#@cdktf/provider-azurestack.lbBackendAddressPool.LbBackendAddressPool.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&lbbackendaddresspool.LbBackendAddressPoolConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v3.lbBackendAddressPool.LbBackendAddressPoolTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurestack.lbBackendAddressPool.LbBackendAddressPoolConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
