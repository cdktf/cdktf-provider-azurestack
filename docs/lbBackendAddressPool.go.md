...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v9/lbbackendaddresspool"
...
&lbbackendaddresspool.LbBackendAddressPoolConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v9.lbBackendAddressPool.LbBackendAddressPoolTimeouts,
}
```
