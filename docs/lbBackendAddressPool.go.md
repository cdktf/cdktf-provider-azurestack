...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v5/lbbackendaddresspool"
...
&lbbackendaddresspool.LbBackendAddressPoolConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v5.lbBackendAddressPool.LbBackendAddressPoolTimeouts,
}
```
