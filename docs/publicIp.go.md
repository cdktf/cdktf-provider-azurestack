...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v5/publicip"
...
&publicip.PublicIpConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v5.publicIp.PublicIpTimeouts,
}
```
