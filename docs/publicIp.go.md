...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v9/publicip"
...
&publicip.PublicIpConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v9.publicIp.PublicIpTimeouts,
}
```
