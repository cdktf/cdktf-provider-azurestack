...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v6/storageblob"
...
&storageblob.StorageBlobConfig {
	...
	SourceUri: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v6.storageBlob.StorageBlobTimeouts,
}
```
