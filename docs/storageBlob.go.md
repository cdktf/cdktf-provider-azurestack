...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v5/storageblob"
...
&storageblob.StorageBlobConfig {
	...
	SourceUri: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v5.storageBlob.StorageBlobTimeouts,
}
```
