...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v3/storageblob"
...
&storageblob.StorageBlobConfig {
	...
	SourceUri: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v3.storageBlob.StorageBlobTimeouts,
}
```
