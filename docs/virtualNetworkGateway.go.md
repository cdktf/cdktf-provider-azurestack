...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v6/virtualnetworkgateway"
...
&virtualnetworkgateway.VirtualNetworkGatewayConfig {
	...
	BgpSettings: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v6.virtualNetworkGateway.VirtualNetworkGatewayBgpSettings,
	DefaultLocalNetworkGatewayId: *string,
	EnableBgp: interface{},
	Id: *string,
	Tags: *map[string]*string,
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v6.virtualNetworkGateway.VirtualNetworkGatewayTimeouts,
	VpnClientConfiguration: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v6.virtualNetworkGateway.VirtualNetworkGatewayVpnClientConfiguration,
	VpnType: *string,
}
```
