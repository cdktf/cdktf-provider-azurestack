...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v5/virtualnetworkgateway"
...
&virtualnetworkgateway.VirtualNetworkGatewayConfig {
	...
	BgpSettings: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v5.virtualNetworkGateway.VirtualNetworkGatewayBgpSettings,
	DefaultLocalNetworkGatewayId: *string,
	EnableBgp: interface{},
	Id: *string,
	Tags: *map[string]*string,
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v5.virtualNetworkGateway.VirtualNetworkGatewayTimeouts,
	VpnClientConfiguration: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v5.virtualNetworkGateway.VirtualNetworkGatewayVpnClientConfiguration,
	VpnType: *string,
}
```
