...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v9/subnet"
...
&subnet.SubnetConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v9.subnet.SubnetTimeouts,
}
```
