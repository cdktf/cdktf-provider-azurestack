...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v3/subnet"
...
&subnet.SubnetConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v3.subnet.SubnetTimeouts,
}
```
