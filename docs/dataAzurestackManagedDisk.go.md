...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v6/dataazurestackmanageddisk"
...
&dataazurestackmanageddisk.DataAzurestackManagedDiskConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v6.dataAzurestackManagedDisk.DataAzurestackManagedDiskTimeouts,
}
```
