...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v5/dataazurestackmanageddisk"
...
&dataazurestackmanageddisk.DataAzurestackManagedDiskConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v5.dataAzurestackManagedDisk.DataAzurestackManagedDiskTimeouts,
}
```
