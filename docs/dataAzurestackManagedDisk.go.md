...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v9/dataazurestackmanageddisk"
...
&dataazurestackmanageddisk.DataAzurestackManagedDiskConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v9.dataAzurestackManagedDisk.DataAzurestackManagedDiskTimeouts,
}
```
