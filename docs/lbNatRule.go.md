...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v6/lbnatrule"
...
&lbnatrule.LbNatRuleConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v6.lbNatRule.LbNatRuleTimeouts,
}
```
