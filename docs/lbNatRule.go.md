...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v5/lbnatrule"
...
&lbnatrule.LbNatRuleConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v5.lbNatRule.LbNatRuleTimeouts,
}
```
