...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v3/virtualmachinescalesetextension"
...
&virtualmachinescalesetextension.VirtualMachineScaleSetExtensionAConfig {
	...
	Settings: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v3.virtualMachineScaleSetExtension.VirtualMachineScaleSetExtensionTimeouts,
}
```
