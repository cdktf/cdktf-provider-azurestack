...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v6/virtualmachinescalesetextension"
...
&virtualmachinescalesetextension.VirtualMachineScaleSetExtensionAConfig {
	...
	Settings: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v6.virtualMachineScaleSetExtension.VirtualMachineScaleSetExtensionTimeouts,
}
```
