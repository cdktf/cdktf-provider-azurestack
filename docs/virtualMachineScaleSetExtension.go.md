...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v5/virtualmachinescalesetextension"
...
&virtualmachinescalesetextension.VirtualMachineScaleSetExtensionAConfig {
	...
	Settings: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v5.virtualMachineScaleSetExtension.VirtualMachineScaleSetExtensionTimeouts,
}
```
