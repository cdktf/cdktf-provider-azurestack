...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v6/dnsnsrecord"
...
&dnsnsrecord.DnsNsRecordConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v6.dnsNsRecord.DnsNsRecordTimeouts,
}
```
