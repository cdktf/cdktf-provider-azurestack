...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v3/dnsnsrecord"
...
&dnsnsrecord.DnsNsRecordConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v3.dnsNsRecord.DnsNsRecordTimeouts,
}
```
