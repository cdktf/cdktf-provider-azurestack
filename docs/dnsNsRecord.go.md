...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v5/dnsnsrecord"
...
&dnsnsrecord.DnsNsRecordConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v5.dnsNsRecord.DnsNsRecordTimeouts,
}
```
