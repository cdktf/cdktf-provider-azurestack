...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v4/dnsnsrecord"
...
&dnsnsrecord.DnsNsRecordConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v4.dnsNsRecord.DnsNsRecordTimeouts,
}
```
