...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v6/dnsarecord"
...
&dnsarecord.DnsARecordConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v6.dnsARecord.DnsARecordTimeouts,
}
```
