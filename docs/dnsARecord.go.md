...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v5/dnsarecord"
...
&dnsarecord.DnsARecordConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v5.dnsARecord.DnsARecordTimeouts,
}
```
