...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v3/dnsarecord"
...
&dnsarecord.DnsARecordConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v3.dnsARecord.DnsARecordTimeouts,
}
```
