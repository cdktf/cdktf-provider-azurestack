...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v3/dnsaaaarecord"
...
&dnsaaaarecord.DnsAaaaRecordConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v3.dnsAaaaRecord.DnsAaaaRecordTimeouts,
}
```
