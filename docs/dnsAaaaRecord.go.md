...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v6/dnsaaaarecord"
...
&dnsaaaarecord.DnsAaaaRecordConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v6.dnsAaaaRecord.DnsAaaaRecordTimeouts,
}
```
