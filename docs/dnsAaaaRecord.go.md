...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v5/dnsaaaarecord"
...
&dnsaaaarecord.DnsAaaaRecordConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v5.dnsAaaaRecord.DnsAaaaRecordTimeouts,
}
```
