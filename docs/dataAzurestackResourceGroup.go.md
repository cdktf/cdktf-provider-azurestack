...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v4/dataazurestackresourcegroup"
...
&dataazurestackresourcegroup.DataAzurestackResourceGroupConfig {
	...
	Name: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v4.dataAzurestackResourceGroup.DataAzurestackResourceGroupTimeouts,
}
```
