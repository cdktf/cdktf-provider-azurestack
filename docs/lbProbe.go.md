...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v9/lbprobe"
...
&lbprobe.LbProbeConfig {
	...
	Protocol: *string,
	RequestPath: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v9.lbProbe.LbProbeTimeouts,
}
```
