...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v6/lbprobe"
...
&lbprobe.LbProbeConfig {
	...
	Protocol: *string,
	RequestPath: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v6.lbProbe.LbProbeTimeouts,
}
```
