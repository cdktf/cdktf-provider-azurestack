...
dataAzurestackVirtualNetworkGateway.DataAzurestackVirtualNetworkGateway.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
```typescript
public readonly timeoutsInput: IResolvable | DataAzurestackVirtualNetworkGatewayTimeouts;
```
...
```typescript
public readonly internalValue: IResolvable | DataAzurestackVirtualNetworkGatewayTimeouts;
```
