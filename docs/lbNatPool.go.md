...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v3/lbnatpool"
...
&lbnatpool.LbNatPoolConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v3.lbNatPool.LbNatPoolTimeouts,
}
```
