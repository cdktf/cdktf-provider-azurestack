...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v5/lbnatpool"
...
&lbnatpool.LbNatPoolConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v5.lbNatPool.LbNatPoolTimeouts,
}
```
