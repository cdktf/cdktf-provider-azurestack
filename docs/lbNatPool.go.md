...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v9/lbnatpool"
...
&lbnatpool.LbNatPoolConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v9.lbNatPool.LbNatPoolTimeouts,
}
```
