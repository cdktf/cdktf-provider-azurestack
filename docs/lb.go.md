...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v6/lb"
...
&lb.LbConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v6.lb.LbTimeouts,
}
```
