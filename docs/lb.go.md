...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v9/lb"
...
&lb.LbConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v9.lb.LbTimeouts,
}
```
