...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v3/lb"
...
&lb.LbConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v3.lb.LbTimeouts,
}
```
