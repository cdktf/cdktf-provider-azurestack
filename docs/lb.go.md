...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v5/lb"
...
&lb.LbConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v5.lb.LbTimeouts,
}
```
