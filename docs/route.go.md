...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v6/route"
...
&route.RouteConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v6.route.RouteTimeouts,
}
```
