...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v5/route"
...
| <code><a href="#@cdktf/provider-azurestack.route.Route.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
&route.RouteConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v5.route.RouteTimeouts,
}
```
