...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v9/route"
...
&route.RouteConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v9.route.RouteTimeouts,
}
```
