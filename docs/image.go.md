...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v3/image"
...
&image.ImageConfig {
	...
	DataDisk: interface{},
	Id: *string,
	OsDisk: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v3.image.ImageOsDisk,
	SourceVirtualMachineId: *string,
	Tags: *map[string]*string,
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v3.image.ImageTimeouts,
}
```
