...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v9/image"
...
&image.ImageConfig {
	...
	DataDisk: interface{},
	Id: *string,
	OsDisk: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v9.image.ImageOsDisk,
	SourceVirtualMachineId: *string,
	Tags: *map[string]*string,
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v9.image.ImageTimeouts,
}
```
