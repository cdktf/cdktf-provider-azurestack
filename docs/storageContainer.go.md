...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v6/storagecontainer"
...
&storagecontainer.StorageContainerConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v6.storageContainer.StorageContainerTimeouts,
}
```
