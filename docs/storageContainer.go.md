...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v5/storagecontainer"
...
&storagecontainer.StorageContainerConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v5.storageContainer.StorageContainerTimeouts,
}
```
