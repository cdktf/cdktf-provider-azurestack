...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v3/storagecontainer"
...
&storagecontainer.StorageContainerConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v3.storageContainer.StorageContainerTimeouts,
}
```
