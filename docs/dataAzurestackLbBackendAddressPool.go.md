...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v6/dataazurestacklbbackendaddresspool"
...
&dataazurestacklbbackendaddresspool.DataAzurestackLbBackendAddressPoolConfig {
	...
	Name: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v6.dataAzurestackLbBackendAddressPool.DataAzurestackLbBackendAddressPoolTimeouts,
}
```
