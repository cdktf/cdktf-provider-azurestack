...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v5/dataazurestackstoragecontainer"
...
&dataazurestackstoragecontainer.DataAzurestackStorageContainerConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v5.dataAzurestackStorageContainer.DataAzurestackStorageContainerTimeouts,
}
```
