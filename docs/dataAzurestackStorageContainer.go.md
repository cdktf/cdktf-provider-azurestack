...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v6/dataazurestackstoragecontainer"
...
&dataazurestackstoragecontainer.DataAzurestackStorageContainerConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v6.dataAzurestackStorageContainer.DataAzurestackStorageContainerTimeouts,
}
```
