...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v3/keyvaultkey"
...
&keyvaultkey.KeyVaultKeyConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v3.keyVaultKey.KeyVaultKeyTimeouts,
}
```
