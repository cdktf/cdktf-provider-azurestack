...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v5/keyvaultkey"
...
&keyvaultkey.KeyVaultKeyConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v5.keyVaultKey.KeyVaultKeyTimeouts,
}
```
