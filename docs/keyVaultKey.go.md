...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v6/keyvaultkey"
...
&keyvaultkey.KeyVaultKeyConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v6.keyVaultKey.KeyVaultKeyTimeouts,
}
```
