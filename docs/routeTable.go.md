...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v5/routetable"
...
&routetable.RouteTableConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v5.routeTable.RouteTableTimeouts,
}
```
