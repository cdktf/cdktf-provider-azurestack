...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v6/routetable"
...
&routetable.RouteTableConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v6.routeTable.RouteTableTimeouts,
}
```
