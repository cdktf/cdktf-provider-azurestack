...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v3/routetable"
...
&routetable.RouteTableConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v3.routeTable.RouteTableTimeouts,
}
```
