...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v4/routetable"
...
&routetable.RouteTableConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v4.routeTable.RouteTableTimeouts,
}
```
