...
//  .disableBgpRoutePropagation(java.lang.Boolean|IResolvable)
//  .id(java.lang.String)
...
| <code><a href="#@cdktf/provider-azurestack.routeTable.RouteTable.Initializer.parameter.connection">connection</a></code> | <code>com.hashicorp.cdktf.SSHProvisionerConnection\|com.hashicorp.cdktf.WinrmProvisionerConnection</code> | *No description.* |
| <code><a href="#@cdktf/provider-azurestack.routeTable.RouteTable.Initializer.parameter.count">count</a></code> | <code>java.lang.Number\|com.hashicorp.cdktf.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-azurestack.routeTable.RouteTable.Initializer.parameter.provisioners">provisioners</a></code> | <code>java.util.List<com.hashicorp.cdktf.FileProvisioner\|com.hashicorp.cdktf.LocalExecProvisioner\|com.hashicorp.cdktf.RemoteExecProvisioner></code> | *No description.* |
...
| <code><a href="#@cdktf/provider-azurestack.routeTable.RouteTable.Initializer.parameter.disableBgpRoutePropagation">disableBgpRoutePropagation</a></code> | <code>java.lang.Boolean\|com.hashicorp.cdktf.IResolvable</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurestack/1.0.0/docs/resources/route_table#disable_bgp_route_propagation RouteTable#disable_bgp_route_propagation}. |
...
| <code><a href="#@cdktf/provider-azurestack.routeTable.RouteTable.Initializer.parameter.route">route</a></code> | <code>com.hashicorp.cdktf.IResolvable\|java.util.List<<a href="#@cdktf/provider-azurestack.routeTable.RouteTableRoute">RouteTableRoute</a>></code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurestack/1.0.0/docs/resources/route_table#route RouteTable#route}. |
...
- *Type:* com.hashicorp.cdktf.IResolvable|java.util.List<<a href="#@cdktf/provider-azurestack.routeTable.RouteTableRoute">RouteTableRoute</a>>
...
| <code><a href="#@cdktf/provider-azurestack.routeTable.RouteTable.toHclTerraform">toHclTerraform</a></code> | *No description.* |
...
| <code><a href="#@cdktf/provider-azurestack.routeTable.RouteTable.hasResourceMove">hasResourceMove</a></code> | *No description.* |
...
| <code><a href="#@cdktf/provider-azurestack.routeTable.RouteTable.moveFromId">moveFromId</a></code> | Move the resource corresponding to "id" to this resource. |
...
| <code><a href="#@cdktf/provider-azurestack.routeTable.RouteTable.moveToId">moveToId</a></code> | Moves this resource to the resource corresponding to "id". |
...
##### `toHclTerraform` <a name="toHclTerraform" id="@cdktf/provider-azurestack.routeTable.RouteTable.toHclTerraform"></a>
...
##### `hasResourceMove` <a name="hasResourceMove" id="@cdktf/provider-azurestack.routeTable.RouteTable.hasResourceMove"></a>
...
##### `moveFromId` <a name="moveFromId" id="@cdktf/provider-azurestack.routeTable.RouteTable.moveFromId"></a>
...
##### `moveToId` <a name="moveToId" id="@cdktf/provider-azurestack.routeTable.RouteTable.moveToId"></a>
...
| <code><a href="#@cdktf/provider-azurestack.routeTable.RouteTable.property.connection">connection</a></code> | <code>com.hashicorp.cdktf.SSHProvisionerConnection\|com.hashicorp.cdktf.WinrmProvisionerConnection</code> | *No description.* |
| <code><a href="#@cdktf/provider-azurestack.routeTable.RouteTable.property.count">count</a></code> | <code>java.lang.Number\|com.hashicorp.cdktf.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-azurestack.routeTable.RouteTable.property.provisioners">provisioners</a></code> | <code>java.util.List<com.hashicorp.cdktf.FileProvisioner\|com.hashicorp.cdktf.LocalExecProvisioner\|com.hashicorp.cdktf.RemoteExecProvisioner></code> | *No description.* |
...
| <code><a href="#@cdktf/provider-azurestack.routeTable.RouteTable.property.disableBgpRoutePropagationInput">disableBgpRoutePropagationInput</a></code> | <code>java.lang.Boolean\|com.hashicorp.cdktf.IResolvable</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-azurestack.routeTable.RouteTable.property.routeInput">routeInput</a></code> | <code>com.hashicorp.cdktf.IResolvable\|java.util.List<<a href="#@cdktf/provider-azurestack.routeTable.RouteTableRoute">RouteTableRoute</a>></code> | *No description.* |
...
| <code><a href="#@cdktf/provider-azurestack.routeTable.RouteTable.property.timeoutsInput">timeoutsInput</a></code> | <code>com.hashicorp.cdktf.IResolvable\|<a href="#@cdktf/provider-azurestack.routeTable.RouteTableTimeouts">RouteTableTimeouts</a></code> | *No description.* |
| <code><a href="#@cdktf/provider-azurestack.routeTable.RouteTable.property.disableBgpRoutePropagation">disableBgpRoutePropagation</a></code> | <code>java.lang.Boolean\|com.hashicorp.cdktf.IResolvable</code> | *No description.* |
...
```java
public java.lang.Boolean|IResolvable getDisableBgpRoutePropagationInput();
```
...
- *Type:* com.hashicorp.cdktf.IResolvable|<a href="#@cdktf/provider-azurestack.routeTable.RouteTableTimeouts">RouteTableTimeouts</a>
...
```java
public java.lang.Boolean|IResolvable getDisableBgpRoutePropagation();
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktf/provider-azurestack.routeTable.RouteTableConfig.property.connection">connection</a></code> | <code>com.hashicorp.cdktf.SSHProvisionerConnection\|com.hashicorp.cdktf.WinrmProvisionerConnection</code> | *No description.* |
| <code><a href="#@cdktf/provider-azurestack.routeTable.RouteTableConfig.property.count">count</a></code> | <code>java.lang.Number\|com.hashicorp.cdktf.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-azurestack.routeTable.RouteTableConfig.property.provisioners">provisioners</a></code> | <code>java.util.List<com.hashicorp.cdktf.FileProvisioner\|com.hashicorp.cdktf.LocalExecProvisioner\|com.hashicorp.cdktf.RemoteExecProvisioner></code> | *No description.* |
...
| **Name** | **Description** |
| --- | --- |
| <code><a href="#@cdktf/provider-azurestack.routeTable.RouteTableRouteList.allWithMapKey">allWithMapKey</a></code> | Creating an iterator for this complex list. |
...
##### `allWithMapKey` <a name="allWithMapKey" id="@cdktf/provider-azurestack.routeTable.RouteTableRouteList.allWithMapKey"></a>
...
###### `mapKeyAttributeName`<sup>Required</sup> <a name="mapKeyAttributeName" id="@cdktf/provider-azurestack.routeTable.RouteTableRouteList.allWithMapKey.parameter.mapKeyAttributeName"></a>
...
| <code><a href="#@cdktf/provider-azurestack.routeTable.RouteTableRouteList.property.internalValue">internalValue</a></code> | <code>com.hashicorp.cdktf.IResolvable\|java.util.List<<a href="#@cdktf/provider-azurestack.routeTable.RouteTableRoute">RouteTableRoute</a>></code> | *No description.* |
...
| <code><a href="#@cdktf/provider-azurestack.routeTable.RouteTableRouteOutputReference.property.internalValue">internalValue</a></code> | <code>com.hashicorp.cdktf.IResolvable\|<a href="#@cdktf/provider-azurestack.routeTable.RouteTableRoute">RouteTableRoute</a></code> | *No description.* |
...
- *Type:* com.hashicorp.cdktf.IResolvable|<a href="#@cdktf/provider-azurestack.routeTable.RouteTableRoute">RouteTableRoute</a>
...
| <code><a href="#@cdktf/provider-azurestack.routeTable.RouteTableTimeoutsOutputReference.property.internalValue">internalValue</a></code> | <code>com.hashicorp.cdktf.IResolvable\|<a href="#@cdktf/provider-azurestack.routeTable.RouteTableTimeouts">RouteTableTimeouts</a></code> | *No description.* |
