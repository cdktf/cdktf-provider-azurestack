...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v5/dataazurestackimage"
...
&dataazurestackimage.DataAzurestackImageConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v5.dataAzurestackImage.DataAzurestackImageTimeouts,
}
```
