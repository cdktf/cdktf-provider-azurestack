...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v3/dataazurestackimage"
...
&dataazurestackimage.DataAzurestackImageConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v3.dataAzurestackImage.DataAzurestackImageTimeouts,
}
```
