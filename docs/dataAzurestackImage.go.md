...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v9/dataazurestackimage"
...
&dataazurestackimage.DataAzurestackImageConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v9.dataAzurestackImage.DataAzurestackImageTimeouts,
}
```
