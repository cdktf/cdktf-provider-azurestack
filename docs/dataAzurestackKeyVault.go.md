...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v6/dataazurestackkeyvault"
...
&dataazurestackkeyvault.DataAzurestackKeyVaultConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v6.dataAzurestackKeyVault.DataAzurestackKeyVaultTimeouts,
}
```
