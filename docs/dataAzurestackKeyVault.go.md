...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v9/dataazurestackkeyvault"
...
&dataazurestackkeyvault.DataAzurestackKeyVaultConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v9.dataAzurestackKeyVault.DataAzurestackKeyVaultTimeouts,
}
```
