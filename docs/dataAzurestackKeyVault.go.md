...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v3/dataazurestackkeyvault"
...
&dataazurestackkeyvault.DataAzurestackKeyVaultConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v3.dataAzurestackKeyVault.DataAzurestackKeyVaultTimeouts,
}
```
