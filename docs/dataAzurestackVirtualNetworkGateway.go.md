...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v6/dataazurestackvirtualnetworkgateway"
...
&dataazurestackvirtualnetworkgateway.DataAzurestackVirtualNetworkGatewayConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v6.dataAzurestackVirtualNetworkGateway.DataAzurestackVirtualNetworkGatewayTimeouts,
}
```
