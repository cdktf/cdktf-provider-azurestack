...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v9/resourcegroup"
...
&resourcegroup.ResourceGroupConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v9.resourceGroup.ResourceGroupTimeouts,
}
```
