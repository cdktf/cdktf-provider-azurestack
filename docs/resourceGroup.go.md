...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v5/resourcegroup"
...
&resourcegroup.ResourceGroupConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v5.resourceGroup.ResourceGroupTimeouts,
}
```
