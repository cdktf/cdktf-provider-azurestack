...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v5/dataazurestackpublicips"
...
&dataazurestackpublicips.DataAzurestackPublicIpsConfig {
	...
	Id: *string,
	NamePrefix: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v5.dataAzurestackPublicIps.DataAzurestackPublicIpsTimeouts,
}
```
