...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v6/dataazurestacknetworksecuritygroup"
...
&dataazurestacknetworksecuritygroup.DataAzurestackNetworkSecurityGroupConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v6.dataAzurestackNetworkSecurityGroup.DataAzurestackNetworkSecurityGroupTimeouts,
}
```
