...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v3/dataazurestacknetworksecuritygroup"
...
&dataazurestacknetworksecuritygroup.DataAzurestackNetworkSecurityGroupConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v3.dataAzurestackNetworkSecurityGroup.DataAzurestackNetworkSecurityGroupTimeouts,
}
```
