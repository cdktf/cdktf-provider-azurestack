...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v6/dataazurestackpublicip"
...
&dataazurestackpublicip.DataAzurestackPublicIpConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v6.dataAzurestackPublicIp.DataAzurestackPublicIpTimeouts,
}
```
