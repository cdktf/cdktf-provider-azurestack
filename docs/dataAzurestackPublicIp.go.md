...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v3/dataazurestackpublicip"
...
&dataazurestackpublicip.DataAzurestackPublicIpConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v3.dataAzurestackPublicIp.DataAzurestackPublicIpTimeouts,
}
```
