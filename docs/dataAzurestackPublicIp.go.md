...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v9/dataazurestackpublicip"
...
&dataazurestackpublicip.DataAzurestackPublicIpConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v9.dataAzurestackPublicIp.DataAzurestackPublicIpTimeouts,
}
```
