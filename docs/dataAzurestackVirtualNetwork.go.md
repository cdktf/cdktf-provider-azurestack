...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v6/dataazurestackvirtualnetwork"
...
&dataazurestackvirtualnetwork.DataAzurestackVirtualNetworkConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v6.dataAzurestackVirtualNetwork.DataAzurestackVirtualNetworkTimeouts,
}
```
