...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v5/dataazurestackvirtualnetwork"
...
&dataazurestackvirtualnetwork.DataAzurestackVirtualNetworkConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v5.dataAzurestackVirtualNetwork.DataAzurestackVirtualNetworkTimeouts,
}
```
