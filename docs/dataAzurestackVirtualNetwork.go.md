...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v9/dataazurestackvirtualnetwork"
...
&dataazurestackvirtualnetwork.DataAzurestackVirtualNetworkConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v9.dataAzurestackVirtualNetwork.DataAzurestackVirtualNetworkTimeouts,
}
```
