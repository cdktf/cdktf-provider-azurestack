...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v9/dataazurestacknetworkinterface"
...
&dataazurestacknetworkinterface.DataAzurestackNetworkInterfaceConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v9.dataAzurestackNetworkInterface.DataAzurestackNetworkInterfaceTimeouts,
}
```
