...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v5/dataazurestacknetworkinterface"
...
&dataazurestacknetworkinterface.DataAzurestackNetworkInterfaceConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v5.dataAzurestackNetworkInterface.DataAzurestackNetworkInterfaceTimeouts,
}
```
