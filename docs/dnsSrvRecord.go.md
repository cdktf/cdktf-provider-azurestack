...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v6/dnssrvrecord"
...
&dnssrvrecord.DnsSrvRecordConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v6.dnsSrvRecord.DnsSrvRecordTimeouts,
}
```
