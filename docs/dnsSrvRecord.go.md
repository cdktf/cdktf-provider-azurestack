...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v4/dnssrvrecord"
...
&dnssrvrecord.DnsSrvRecordConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v4.dnsSrvRecord.DnsSrvRecordTimeouts,
}
```
