...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v5/dnssrvrecord"
...
&dnssrvrecord.DnsSrvRecordConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v5.dnsSrvRecord.DnsSrvRecordTimeouts,
}
```
