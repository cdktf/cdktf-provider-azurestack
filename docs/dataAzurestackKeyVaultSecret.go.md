...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v5/dataazurestackkeyvaultsecret"
...
&dataazurestackkeyvaultsecret.DataAzurestackKeyVaultSecretConfig {
	...
	Name: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v5.dataAzurestackKeyVaultSecret.DataAzurestackKeyVaultSecretTimeouts,
}
```
