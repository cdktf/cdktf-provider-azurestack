...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v9/networksecurityrule"
...
&networksecurityrule.NetworkSecurityRuleConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v9.networkSecurityRule.NetworkSecurityRuleTimeouts,
}
```
