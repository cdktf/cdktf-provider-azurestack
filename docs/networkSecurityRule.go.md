...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v5/networksecurityrule"
...
&networksecurityrule.NetworkSecurityRuleConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v5.networkSecurityRule.NetworkSecurityRuleTimeouts,
}
```
