...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v9/dnsptrrecord"
...
&dnsptrrecord.DnsPtrRecordConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v9.dnsPtrRecord.DnsPtrRecordTimeouts,
}
```
