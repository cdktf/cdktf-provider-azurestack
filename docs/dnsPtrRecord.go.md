...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v5/dnsptrrecord"
...
&dnsptrrecord.DnsPtrRecordConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v5.dnsPtrRecord.DnsPtrRecordTimeouts,
}
```
