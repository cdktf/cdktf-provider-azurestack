...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v6/dnsptrrecord"
...
&dnsptrrecord.DnsPtrRecordConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v6.dnsPtrRecord.DnsPtrRecordTimeouts,
}
```
