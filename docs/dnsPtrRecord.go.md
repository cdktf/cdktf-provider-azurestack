...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v4/dnsptrrecord"
...
&dnsptrrecord.DnsPtrRecordConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v4.dnsPtrRecord.DnsPtrRecordTimeouts,
}
```
