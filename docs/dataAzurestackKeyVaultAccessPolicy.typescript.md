...
dataAzurestackKeyVaultAccessPolicy.DataAzurestackKeyVaultAccessPolicyA.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
```typescript
public readonly timeoutsInput: IResolvable | DataAzurestackKeyVaultAccessPolicyTimeouts;
```
...
```typescript
public readonly internalValue: IResolvable | DataAzurestackKeyVaultAccessPolicyTimeouts;
```
