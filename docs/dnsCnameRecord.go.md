...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v6/dnscnamerecord"
...
&dnscnamerecord.DnsCnameRecordConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v6.dnsCnameRecord.DnsCnameRecordTimeouts,
}
```
