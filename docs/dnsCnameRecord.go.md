...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v9/dnscnamerecord"
...
&dnscnamerecord.DnsCnameRecordConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v9.dnsCnameRecord.DnsCnameRecordTimeouts,
}
```
