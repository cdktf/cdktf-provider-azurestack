...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v6/dataazurestackroutetable"
...
&dataazurestackroutetable.DataAzurestackRouteTableConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v6.dataAzurestackRouteTable.DataAzurestackRouteTableTimeouts,
}
```
