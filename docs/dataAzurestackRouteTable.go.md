...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v9/dataazurestackroutetable"
...
&dataazurestackroutetable.DataAzurestackRouteTableConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v9.dataAzurestackRouteTable.DataAzurestackRouteTableTimeouts,
}
```
