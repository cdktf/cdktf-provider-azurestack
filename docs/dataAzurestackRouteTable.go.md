...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v3/dataazurestackroutetable"
...
&dataazurestackroutetable.DataAzurestackRouteTableConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v3.dataAzurestackRouteTable.DataAzurestackRouteTableTimeouts,
}
```
