...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v3/dataazurestacklocalnetworkgateway"
...
&dataazurestacklocalnetworkgateway.DataAzurestackLocalNetworkGatewayConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v3.dataAzurestackLocalNetworkGateway.DataAzurestackLocalNetworkGatewayTimeouts,
}
```
