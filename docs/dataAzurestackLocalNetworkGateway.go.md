...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v6/dataazurestacklocalnetworkgateway"
...
&dataazurestacklocalnetworkgateway.DataAzurestackLocalNetworkGatewayConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v6.dataAzurestackLocalNetworkGateway.DataAzurestackLocalNetworkGatewayTimeouts,
}
```
