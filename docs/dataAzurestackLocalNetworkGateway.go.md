...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v5/dataazurestacklocalnetworkgateway"
...
&dataazurestacklocalnetworkgateway.DataAzurestackLocalNetworkGatewayConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v5.dataAzurestackLocalNetworkGateway.DataAzurestackLocalNetworkGatewayTimeouts,
}
```
