...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v9/dataazurestackresources"
...
&dataazurestackresources.DataAzurestackResourcesConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v9.dataAzurestackResources.DataAzurestackResourcesTimeouts,
	Type: *string,
}
```
