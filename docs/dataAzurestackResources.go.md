...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v6/dataazurestackresources"
...
&dataazurestackresources.DataAzurestackResourcesConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v6.dataAzurestackResources.DataAzurestackResourcesTimeouts,
	Type: *string,
}
```
