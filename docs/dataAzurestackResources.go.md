...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v4/dataazurestackresources"
...
&dataazurestackresources.DataAzurestackResourcesConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v4.dataAzurestackResources.DataAzurestackResourcesTimeouts,
	Type: *string,
}
```
