...
dataAzurestackLbBackendAddressPool.DataAzurestackLbBackendAddressPool.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
```typescript
public readonly timeoutsInput: IResolvable | DataAzurestackLbBackendAddressPoolTimeouts;
```
...
```typescript
public readonly internalValue: IResolvable | DataAzurestackLbBackendAddressPoolTimeouts;
```
