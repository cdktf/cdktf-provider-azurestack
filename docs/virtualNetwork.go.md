...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v5/virtualnetwork"
...
&virtualnetwork.VirtualNetworkConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v5.virtualNetwork.VirtualNetworkTimeouts,
}
```
