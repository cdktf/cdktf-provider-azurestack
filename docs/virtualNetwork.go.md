...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v6/virtualnetwork"
...
&virtualnetwork.VirtualNetworkConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v6.virtualNetwork.VirtualNetworkTimeouts,
}
```
