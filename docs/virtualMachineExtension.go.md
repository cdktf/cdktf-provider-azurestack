...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v9/virtualmachineextension"
...
&virtualmachineextension.VirtualMachineExtensionConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v9.virtualMachineExtension.VirtualMachineExtensionTimeouts,
}
```
