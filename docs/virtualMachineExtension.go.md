...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v5/virtualmachineextension"
...
&virtualmachineextension.VirtualMachineExtensionConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v5.virtualMachineExtension.VirtualMachineExtensionTimeouts,
}
```
