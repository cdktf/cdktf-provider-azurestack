...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v5/dataazurestackkeyvaultkey"
...
&dataazurestackkeyvaultkey.DataAzurestackKeyVaultKeyConfig {
	...
	Name: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v5.dataAzurestackKeyVaultKey.DataAzurestackKeyVaultKeyTimeouts,
}
```
