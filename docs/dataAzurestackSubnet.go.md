...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v6/dataazurestacksubnet"
...
&dataazurestacksubnet.DataAzurestackSubnetConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v6.dataAzurestackSubnet.DataAzurestackSubnetTimeouts,
}
```
