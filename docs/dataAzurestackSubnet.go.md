...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v3/dataazurestacksubnet"
...
&dataazurestacksubnet.DataAzurestackSubnetConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v3.dataAzurestackSubnet.DataAzurestackSubnetTimeouts,
}
```
