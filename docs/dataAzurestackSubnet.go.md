...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v9/dataazurestacksubnet"
...
&dataazurestacksubnet.DataAzurestackSubnetConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v9.dataAzurestackSubnet.DataAzurestackSubnetTimeouts,
}
```
