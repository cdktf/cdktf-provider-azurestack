...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v5/dataazurestacksubnet"
...
&dataazurestacksubnet.DataAzurestackSubnetConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v5.dataAzurestackSubnet.DataAzurestackSubnetTimeouts,
}
```
