...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v6/dataazurestackclientconfig"
...
&dataazurestackclientconfig.DataAzurestackClientConfigConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v6.dataAzurestackClientConfig.DataAzurestackClientConfigTimeouts,
}
```
