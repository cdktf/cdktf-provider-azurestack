...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v4/dataazurestackclientconfig"
...
&dataazurestackclientconfig.DataAzurestackClientConfigConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v4.dataAzurestackClientConfig.DataAzurestackClientConfigTimeouts,
}
```
