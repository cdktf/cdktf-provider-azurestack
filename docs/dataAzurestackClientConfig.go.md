...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v5/dataazurestackclientconfig"
...
&dataazurestackclientconfig.DataAzurestackClientConfigConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v5.dataAzurestackClientConfig.DataAzurestackClientConfigTimeouts,
}
```
