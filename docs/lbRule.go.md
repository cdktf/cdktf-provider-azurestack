...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v4/lbrule"
...
&lbrule.LbRuleConfig {
	...
	ProbeId: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v4.lbRule.LbRuleTimeouts,
}
```
