...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v5/lbrule"
...
&lbrule.LbRuleConfig {
	...
	ProbeId: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v5.lbRule.LbRuleTimeouts,
}
```
