...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v9/lbrule"
...
&lbrule.LbRuleConfig {
	...
	ProbeId: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v9.lbRule.LbRuleTimeouts,
}
```
