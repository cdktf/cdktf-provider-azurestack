...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v3/manageddisk"
...
&manageddisk.ManagedDiskConfig {
	...
	DiskSizeGb: *f64,
	Encryption: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v3.managedDisk.ManagedDiskEncryption,
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v3.managedDisk.ManagedDiskTimeouts,
}
```
...
&manageddisk.ManagedDiskEncryption {
	Enabled: interface{},
	DiskEncryptionKey: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v3.managedDisk.ManagedDiskEncryptionDiskEncryptionKey,
	KeyEncryptionKey: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v3.managedDisk.ManagedDiskEncryptionKeyEncryptionKey,
}
```
