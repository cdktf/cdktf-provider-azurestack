...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v6/manageddisk"
...
&manageddisk.ManagedDiskConfig {
	...
	DiskSizeGb: *f64,
	Encryption: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v6.managedDisk.ManagedDiskEncryption,
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v6.managedDisk.ManagedDiskTimeouts,
}
```
...
&manageddisk.ManagedDiskEncryption {
	Enabled: interface{},
	DiskEncryptionKey: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v6.managedDisk.ManagedDiskEncryptionDiskEncryptionKey,
	KeyEncryptionKey: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v6.managedDisk.ManagedDiskEncryptionKeyEncryptionKey,
}
```
