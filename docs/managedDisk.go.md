...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v5/manageddisk"
...
&manageddisk.ManagedDiskConfig {
	...
	DiskSizeGb: *f64,
	Encryption: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v5.managedDisk.ManagedDiskEncryption,
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v5.managedDisk.ManagedDiskTimeouts,
}
```
...
&manageddisk.ManagedDiskEncryption {
	Enabled: interface{},
	DiskEncryptionKey: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v5.managedDisk.ManagedDiskEncryptionDiskEncryptionKey,
	KeyEncryptionKey: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v5.managedDisk.ManagedDiskEncryptionKeyEncryptionKey,
}
```
