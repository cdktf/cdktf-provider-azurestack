...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v4/dnsmxrecord"
...
&dnsmxrecord.DnsMxRecordConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v4.dnsMxRecord.DnsMxRecordTimeouts,
}
```
