...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v6/dnsmxrecord"
...
&dnsmxrecord.DnsMxRecordConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v6.dnsMxRecord.DnsMxRecordTimeouts,
}
```
