...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v5/dnsmxrecord"
...
&dnsmxrecord.DnsMxRecordConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v5.dnsMxRecord.DnsMxRecordTimeouts,
}
```
