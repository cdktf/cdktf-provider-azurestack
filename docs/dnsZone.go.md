...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v5/dnszone"
...
&dnszone.DnsZoneConfig {
	...
	Id: *string,
	SoaRecord: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v5.dnsZone.DnsZoneSoaRecord,
	Tags: *map[string]*string,
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v5.dnsZone.DnsZoneTimeouts,
}
```
