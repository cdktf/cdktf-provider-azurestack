...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v5/dataazurestacklbrule"
...
&dataazurestacklbrule.DataAzurestackLbRuleConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v5.dataAzurestackLbRule.DataAzurestackLbRuleTimeouts,
}
```
