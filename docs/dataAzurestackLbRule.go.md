...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v6/dataazurestacklbrule"
...
&dataazurestacklbrule.DataAzurestackLbRuleConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v6.dataAzurestackLbRule.DataAzurestackLbRuleTimeouts,
}
```
