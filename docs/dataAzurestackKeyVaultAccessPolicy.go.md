...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v3/dataazurestackkeyvaultaccesspolicy"
...
&dataazurestackkeyvaultaccesspolicy.DataAzurestackKeyVaultAccessPolicyAConfig {
	...
	Name: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v3.dataAzurestackKeyVaultAccessPolicy.DataAzurestackKeyVaultAccessPolicyTimeouts,
}
```
