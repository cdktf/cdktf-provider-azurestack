...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v3/dataazurestackdnszone"
...
&dataazurestackdnszone.DataAzurestackDnsZoneConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v3.dataAzurestackDnsZone.DataAzurestackDnsZoneTimeouts,
}
```
