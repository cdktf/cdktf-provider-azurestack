...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v5/dataazurestackdnszone"
...
&dataazurestackdnszone.DataAzurestackDnsZoneConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v5.dataAzurestackDnsZone.DataAzurestackDnsZoneTimeouts,
}
```
