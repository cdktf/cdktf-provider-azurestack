...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v4/dataazurestackdnszone"
...
| <code><a href="#@cdktf/provider-azurestack.dataAzurestackDnsZone.DataAzurestackDnsZone.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&dataazurestackdnszone.DataAzurestackDnsZoneConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v4.dataAzurestackDnsZone.DataAzurestackDnsZoneTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurestack.dataAzurestackDnsZone.DataAzurestackDnsZoneConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
