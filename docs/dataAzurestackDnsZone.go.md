...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v9/dataazurestackdnszone"
...
&dataazurestackdnszone.DataAzurestackDnsZoneConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v9.dataAzurestackDnsZone.DataAzurestackDnsZoneTimeouts,
}
```
