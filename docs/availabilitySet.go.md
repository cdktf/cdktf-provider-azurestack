...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v5/availabilityset"
...
&availabilityset.AvailabilitySetConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v5.availabilitySet.AvailabilitySetTimeouts,
}
```
