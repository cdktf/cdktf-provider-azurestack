...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v3/availabilityset"
...
&availabilityset.AvailabilitySetConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v3.availabilitySet.AvailabilitySetTimeouts,
}
```
