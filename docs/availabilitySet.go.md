...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v6/availabilityset"
...
&availabilityset.AvailabilitySetConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v6.availabilitySet.AvailabilitySetTimeouts,
}
```
