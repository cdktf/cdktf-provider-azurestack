...
```typescript
public readonly timeoutsInput: VirtualMachineDataDiskAttachmentTimeouts | IResolvable;
```

- *Type:* <a href="#@cdktf/provider-azurestack.virtualMachineDataDiskAttachment.VirtualMachineDataDiskAttachmentTimeouts">VirtualMachineDataDiskAttachmentTimeouts</a> | cdktf.IResolvable
...
```typescript
public readonly internalValue: VirtualMachineDataDiskAttachmentTimeouts | IResolvable;
```
