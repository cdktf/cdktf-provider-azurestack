...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v5/templatedeployment"
...
&templatedeployment.TemplateDeploymentConfig {
	...
	TemplateBody: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v5.templateDeployment.TemplateDeploymentTimeouts,
}
```
