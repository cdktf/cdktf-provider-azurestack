...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v6/templatedeployment"
...
&templatedeployment.TemplateDeploymentConfig {
	...
	TemplateBody: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v6.templateDeployment.TemplateDeploymentTimeouts,
}
```
