...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v9/templatedeployment"
...
&templatedeployment.TemplateDeploymentConfig {
	...
	TemplateBody: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v9.templateDeployment.TemplateDeploymentTimeouts,
}
```
