...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v5/localnetworkgateway"
...
&localnetworkgateway.LocalNetworkGatewayConfig {
	...
	AddressSpace: *[]*string,
	BgpSettings: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v5.localNetworkGateway.LocalNetworkGatewayBgpSettings,
	Id: *string,
	Tags: *map[string]*string,
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v5.localNetworkGateway.LocalNetworkGatewayTimeouts,
}
```
