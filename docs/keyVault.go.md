...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v5/keyvault"
...
&keyvault.KeyVaultConfig {
	...
	Id: *string,
	NetworkAcls: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v5.keyVault.KeyVaultNetworkAcls,
	Tags: *map[string]*string,
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v5.keyVault.KeyVaultTimeouts,
}
```
