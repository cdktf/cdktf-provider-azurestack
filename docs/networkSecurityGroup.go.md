...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v5/networksecuritygroup"
...
&networksecuritygroup.NetworkSecurityGroupConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v5.networkSecurityGroup.NetworkSecurityGroupTimeouts,
}
```
