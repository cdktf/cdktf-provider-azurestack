...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v6/networksecuritygroup"
...
&networksecuritygroup.NetworkSecurityGroupConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v6.networkSecurityGroup.NetworkSecurityGroupTimeouts,
}
```
