...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v3/networksecuritygroup"
...
&networksecuritygroup.NetworkSecurityGroupConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v3.networkSecurityGroup.NetworkSecurityGroupTimeouts,
}
```
