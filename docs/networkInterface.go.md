...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v5/networkinterface"
...
&networkinterface.NetworkInterfaceConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v5.networkInterface.NetworkInterfaceTimeouts,
}
```
