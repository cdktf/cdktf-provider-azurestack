...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v6/networkinterface"
...
&networkinterface.NetworkInterfaceConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v6.networkInterface.NetworkInterfaceTimeouts,
}
```
