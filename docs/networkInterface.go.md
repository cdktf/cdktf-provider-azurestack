...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v4/networkinterface"
...
&networkinterface.NetworkInterfaceConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v4.networkInterface.NetworkInterfaceTimeouts,
}
```
