...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v5/dataazurestackstorageaccount"
...
&dataazurestackstorageaccount.DataAzurestackStorageAccountConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v5.dataAzurestackStorageAccount.DataAzurestackStorageAccountTimeouts,
}
```
