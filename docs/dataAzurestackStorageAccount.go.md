...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v9/dataazurestackstorageaccount"
...
&dataazurestackstorageaccount.DataAzurestackStorageAccountConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v9.dataAzurestackStorageAccount.DataAzurestackStorageAccountTimeouts,
}
```
