...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v6/dataazurestackstorageaccount"
...
&dataazurestackstorageaccount.DataAzurestackStorageAccountConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v6.dataAzurestackStorageAccount.DataAzurestackStorageAccountTimeouts,
}
```
