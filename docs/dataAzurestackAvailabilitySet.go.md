...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v9/dataazurestackavailabilityset"
...
&dataazurestackavailabilityset.DataAzurestackAvailabilitySetConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v9.dataAzurestackAvailabilitySet.DataAzurestackAvailabilitySetTimeouts,
}
```
