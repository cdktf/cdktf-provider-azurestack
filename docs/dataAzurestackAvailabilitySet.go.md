...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v6/dataazurestackavailabilityset"
...
&dataazurestackavailabilityset.DataAzurestackAvailabilitySetConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v6.dataAzurestackAvailabilitySet.DataAzurestackAvailabilitySetTimeouts,
}
```
