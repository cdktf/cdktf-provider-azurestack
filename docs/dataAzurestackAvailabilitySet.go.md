...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v4/dataazurestackavailabilityset"
...
&dataazurestackavailabilityset.DataAzurestackAvailabilitySetConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v4.dataAzurestackAvailabilitySet.DataAzurestackAvailabilitySetTimeouts,
}
```
