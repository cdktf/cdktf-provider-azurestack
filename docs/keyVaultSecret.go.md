...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v5/keyvaultsecret"
...
&keyvaultsecret.KeyVaultSecretConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v5.keyVaultSecret.KeyVaultSecretTimeouts,
}
```
