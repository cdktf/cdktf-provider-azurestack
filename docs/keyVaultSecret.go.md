...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v6/keyvaultsecret"
...
&keyvaultsecret.KeyVaultSecretConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v6.keyVaultSecret.KeyVaultSecretTimeouts,
}
```
