...
```go
import "github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v9/keyvaultsecret"
...
&keyvaultsecret.KeyVaultSecretConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurestack-go/azurestack/v9.keyVaultSecret.KeyVaultSecretTimeouts,
}
```
