...
export function dataAzurestackVirtualNetworkTimeoutsToHclTerraform(struct?: DataAzurestackVirtualNetworkTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataAzurestackVirtualNetworkTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public set internalValue(value: DataAzurestackVirtualNetworkTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class DataAzurestackVirtualNetwork extends cdktf.TerraformDataSource {
  ...
  * @param importToId The construct id used in the generated config for the DataAzurestackVirtualNetwork to import
  * @param importFromId The id of the existing DataAzurestackVirtualNetwork that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurestack/1.0.0/docs/data-sources/virtual_network#import import section} in the documentation of this resource for the id to use
  ...
  */
  public constructor(scope: Construct, id: string, config: DataAzurestackVirtualNetworkConfig) {
    super(scope, id, {
  ...
  private _timeouts = new DataAzurestackVirtualNetworkTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: DataAzurestackVirtualNetworkTimeouts) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: dataAzurestackVirtualNetworkTimeoutsToTerraform(this._timeouts.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      timeouts: {
        value: dataAzurestackVirtualNetworkTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "DataAzurestackVirtualNetworkTimeouts",
      },
    };
