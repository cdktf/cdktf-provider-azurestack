...
export function dataAzurestackPublicIpTimeoutsToTerraform(struct?: DataAzurestackPublicIpTimeouts | cdktf.IResolvable): any {
...
export function dataAzurestackPublicIpTimeoutsToHclTerraform(struct?: DataAzurestackPublicIpTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataAzurestackPublicIpTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataAzurestackPublicIpTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: DataAzurestackPublicIpTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
*/
export class DataAzurestackPublicIp extends cdktf.TerraformDataSource {
  ...
  * @param importToId The construct id used in the generated config for the DataAzurestackPublicIp to import
  * @param importFromId The id of the existing DataAzurestackPublicIp that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurestack/1.0.0/docs/data-sources/public_ip#import import section} in the documentation of this resource for the id to use
  ...
  */
  public constructor(scope: Construct, id: string, config: DataAzurestackPublicIpConfig) {
    super(scope, id, {
  ...
  private _timeouts = new DataAzurestackPublicIpTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: DataAzurestackPublicIpTimeouts) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: dataAzurestackPublicIpTimeoutsToTerraform(this._timeouts.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      timeouts: {
        value: dataAzurestackPublicIpTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "DataAzurestackPublicIpTimeouts",
      },
    };
